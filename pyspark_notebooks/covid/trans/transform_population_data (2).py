...
df_raw_population = spark.read.csv("/mnt/devcicddemodl9/raw/population", sep=r'\t', header=True)
...
display(df_raw_population.printSchema())
...
df_dim_country = spark.read.csv("/mnt/devcicddemodl9/lookup/dim_country", sep=r',', header=True)
...
df_processed_population.write.format("com.databricks.spark.csv").option("header","true").option("delimiter", ",").mode("overwrite").save("/mnt/devcicddemodl9/processed/population")
